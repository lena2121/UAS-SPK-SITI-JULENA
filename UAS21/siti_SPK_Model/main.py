...
class BaseMethod():
    ...
    def data(self):
        ...
        return [{'id': smartphonelenovo.id, 
        'brand': DEV_SCALE_bran[smartphonelenovo.brand], 
        'ram': DEV_SCALE_ram[smartphonelenovo.ram], 
        'prosesor': DEV_SCALE_prosesor[smartphonelenovo.prosesor], 
        'storage': DEV_SCALE_storage[smartphonelenovo.storage], 
        'baterai': DEV_SCALE_baterai[smartphonelenovo.baterai], 
        'ukuran_layar': DEV_SCALE_ukuran_layar[smartphonelenovo.ukuran_layar], 
        'harga': DEV_SCALE_harga[smartphonelenovo.harga]} for smartphonelenovo in session.scalars(query)]
